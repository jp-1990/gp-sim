...
/**
 * Select images input for liveries/update page. Uses SelectFiles inside a form provider and displays the selected images to the user.
 */
            ...
            {images.map((image, i) => (
              ...
              >
                <ImageWithFallback
                  ...
                  imgAlt={
                    typeof image === 'string' ? 'livery image' : image.name
                  }
                />
                <Button
                  size="sm"
                  ...
                  fontWeight="normal"
                  aria-label={`remove-${
                    typeof image === 'string' ? `livery-image-${i}` : image.name
                  }`}
                >
